...
})({"dNFyv":[function(require,module,exports) {
...
class Login extends (0, _reactDefault.default).Component {
    constructor(props){
        super(props);
        // empty query params 
        let returnTo = encodeURIComponent("https://form.trysheetrocks.dev");
    ...
    render() {
        return /*#__PURE__*/ (0, _reactDefault.default).createElement("div", {
            ...
            src: "logo.png"
        }), /*#__PURE__*/ (0, _reactDefault.default).createElement("iframe", {
            src: `https://sheet.rocks/apps/${"jLWRG8tG3RNQY94"}/auth/login?${this.state.queryParams}`
        }));
    }
}
(0, _reactDomDefault.default).render(/*#__PURE__*/ (0, _reactDefault.default).createElement(Login, null), document.getElementById("root"));

},{"react":"efHxB","react-dom":"b1j47","@parcel/transformer-js/src/esmodule-helpers.js":"iu2ZB"}],"efHxB":[function(require,module,exports) {
"use strict";
...
},{}],"iu2ZB":[function(require,module,exports) {
